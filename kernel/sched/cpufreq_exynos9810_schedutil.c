...
static struct cpufreq_governor exynos9810_schedutil_gov;
...
#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_EXYNOS9810_SCHEDUTIL
struct cpufreq_governor *cpufreq_default_governor(void)
{
	return &exynos9810_schedutil_gov;
}
#endif
static void sugov_update_min(struct cpufreq_policy *policy)
{
...
static int __init sugov_register(void)
{
	...
	return cpufreq_register_governor(&exynos9810_schedutil_gov);
}
